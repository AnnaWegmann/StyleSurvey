...
<table id="papers-table">
  ...
  <tbody>
    <tr>
      <td><em>Writeprints: A stylometric approach to identity-level identification and similarity detection in cyberspace</em></td>
    ...
    <tr>
      <td><em>Fine-grained Analysis of Sentence Embeddings Using Auxiliary Prediction Tasks</em></td>
    ...
    <tr>
      <td><em>Can Authorship Attribution Models Distinguish Speakers in Speech Transcripts?</em></td>
    ...
    <tr>
      <td><em>Content Anonymization for Privacy in Long-form Audio</em></td>
    ...
    <tr>
      <td><em>The impact of automatic speech transcription on speaker attribution</em></td>
    ...
    <tr>
      <td><em>Neurobiber: Fast and Interpretable Stylistic Feature Extraction</em></td>
    ...
    <tr>
      <td><em>SmolLM2: When Smol Goes Big — Data-Centric Training of a Fully Open Small Language Model</em></td>
    ...
    <tr>
      <td><em>Masks and mimicry: Strategic obfuscation and impersonation attacks on authorship verification</em></td>
    ...
    <tr>
      <td><em>Latent Space Interpretation for Stylistic Analysis and Explainable Authorship Attribution</em></td>
    ...
    <tr>
      <td><em>Layered Insights: Generalizable Analysis of Human Authorial Style by Leveraging All Transformer Layers</em></td>
    ...
    <tr>
      <td><em>The topic confusion task: A novel evaluation scenario for authorship attribution</em></td>
    ...
    <tr>
      <td><em>Learning invariant representations of social media users</em></td>
    ...
    <tr>
      <td><em>(Dis)improved?! How Simplified Language Affects Large Language Model Performance across Languages</em></td>
    ...
    <tr>
      <td><em>A light in the dark web: Linking dark web aliases to real internet identities</em></td>
    ...
    <tr>
      <td><em>Computational forensic authorship analysis: Promises and pitfalls</em></td>
    ...
    <tr>
      <td><em>Overview of the International Authorship Identification Competition at PAN-2011</em></td>
    ...
    <tr>
      <td><em>Efficient Large Scale Language Modeling with Mixtures of Experts</em></td>
    ...
    <tr>
      <td><em>The Routledge Handbook of Sociolinguistics Around the World, 2nd edition</em></td>
    ...
    <tr>
      <td><em>The Language That Drives Engagement: A Systematic Large-scale Analysis of Headline Experiments</em></td>
    ...
    <tr>
      <td><em>Keep it Private: Unsupervised privatization of online text</em></td>
    ...
    <tr>
      <td><em>Measuring what Matters: Construct Validity in Large Language Model Benchmarks</em></td>
    ...
    <tr>
      <td><em>Probing classifiers: Promises, shortcomings, and advances</em></td>
    ...
    <tr>
      <td><em>What do neural machine translation models learn about morphology?</em></td>
    ...
    <tr>
      <td><em>Language style as audience design</em></td>
      <td>Allan Bell</td>
    ...
    <tr>
      <td><em>Overview of PAN 2025: Generative AI Detection, Multilingual Text Detoxification, Multi-author Writing Style Analysis, and Generative Plagiarism Detection</em></td>
    ...
    <tr>
      <td><em>The two paradigms of LLM detection: Authorship attribution vs. authorship verification</em></td>
    ...
    <tr>
      <td><em>Variation across Speech and Writing</em></td>
      <td>Douglas Biber</td>
    ...
    <tr>
      <td><em>Register, Genre, and Style, 2nd edition</em></td>
    ...
    <tr>
      <td><em>Natural Language Processing with Python</em></td>
    ...
    <tr>
      <td><em>Centering the speech community</em></td>
    ...
    <tr>
      <td><em>ETS corpus of non-native written English LDC2014T06</em></td>
    ...
    <tr>
      <td><em>The language of intergroup distinctiveness</em></td>
    ...
    <tr>
      <td><em>Rethinking the Authorship Verification Experimental Setups</em></td>
    ...
    <tr>
      <td><em>Adversarial stylometry: Circumventing authorship recognition to preserve privacy and anonymity</em></td>
    ...
    <tr>
      <td><em>'Delta': a measure of stylistic difference and a guide to likely authorship</em></td>
      <td>John Burrows</td>
    ...
    <tr>
      <td><em>How the communication style of chatbots influences consumers' satisfaction, trust, and engagement in the context of service failure</em></td>
    ...
    <tr>
      <td><em>Accent, (ING), and the social logic of listener perceptions</em></td>
    ...
    <tr>
      <td><em>The nature of sociolinguistic perception</em></td>
      <td>Kathryn Campbell-Kibler</td>
    ...
    <tr>
      <td><em>The sociolinguistic variant as a carrier of social meaning</em></td>
      <td>Kathryn Campbell-Kibler</td>
    ...
    <tr>
      <td><em>The elements of style</em></td>
    ...
    <tr>
      <td><em>Expertise style transfer: A new task towards better communication between experts and laymen</em></td>
    ...
    <tr>
      <td><em>On the diversity of synthetic data and its impact on training large language models</em></td>
    ...
    <tr>
      <td><em>HumT DumT: Measuring and controlling human-like language in LLMs</em></td>
    ...
    <tr>
      <td><em>CLUB: a contrastive log-ratio upper bound of mutual information</em></td>
    ...
    <tr>
      <td><em>Improving disentangled text representation learning with information-theoretic guidance</em></td>
    ...
    <tr>
      <td><em>Evaluating synthetic data generation from user generated text</em></td>
    ...
    <tr>
      <td><em>When Variants Lack Semantic Equivalence: Adverbial Subclause Word Order</em></td>
    ...
    <tr>
      <td><em>Conventionality and contrast: Pragmatic principles with lexical consequences</em></td>
      <td>Eve V. Clark</td>
    ...
    <tr>
      <td><em>Dimensions of abusive language on Twitter</em></td>
    ...
    <tr>
      <td><em>Detecting collaborations in text comparing the authors' rhetorical language choices in the federalist papers</em></td>
    ...
    <tr>
      <td><em>Author identification, idiolect, and linguistic uniqueness</em></td>
    ...
    <tr>
      <td><em>Style: Language Variation and Identity</em></td>
    ...
    <tr>
      <td><em>A Dictionary of Linguistics and Phonetics, 6th edition</em></td>
      <td>David Crystal</td>
      <td><a href="https://doi.org/10.1002/9781444302776">link</a></td>
      <td>2011</td>
    ...
    <tr>
      <td><em>Investigating English Style</em></td>
    ...
    <tr>
      <td><em>Learning stylometric representations for authorship analysis</em></td>
    ...
    <tr>
      <td><em>Speaker recognition based on idiolectal differences between speakers</em></td>
    ...
    <tr>
      <td><em>Automatically constructing a corpus of sentential paraphrases</em></td>
    ...
    <tr>
      <td><em>Triplet loss in siamese network for object tracking</em></td>
    ...
    <tr>
      <td><em>Refocusing on relevance: Personalization in NLG</em></td>
    ...
    <tr>
      <td><em>HotFlip: White-Box Adversarial Examples for Text Classification</em></td>
    ...
    <tr>
      <td><em>Jocks and Burnouts: Social Categories and Identity in the High School</em></td>
    ...
    <tr>
      <td><em>Variation and the indexical field</em></td>
      <td>Penelope Eckert</td>
    ...
    <tr>
      <td><em>Three waves of variation study: The emergence of meaning in the study of sociolinguistic variation</em></td>
      <td>Penelope Eckert</td>
    ...
    <tr>
      <td><em>Stylometry with R: A Package for Computational Text Analysis</em></td>
    ...
    <tr>
      <td><em>Analyzing the Persuasive Effect of Style in News Editorial Argumentation</em></td>
    ...
    <tr>
      <td><em>Adversarial removal of demographic attributes from text data</em></td>
    ...
    <tr>
      <td><em>Evaluating the efficacy of AI content detection tools in differentiating between human and AI-generated text</em></td>
    ...
    <tr>
      <td><em>MMTEB: Massive Multilingual Text Embedding Benchmark</em></td>
    ...
    <tr>
      <td><em>Variety, style-shifting, and ideology</em></td>
    ...
    <tr>
      <td><em>Leveraging Measurement Theory for Natural Language Processing Research</em></td>
      <td>Qixiang Fang</td>
    ...
    <tr>
      <td><em>Linguistic bias in ChatGPT: Language models reinforce dialect discrimination</em></td>
    ...
    <tr>
      <td><em>Survey of the state of the art in natural language generation: Core tasks, applications and evaluation</em></td>
    ...
    <tr>
      <td><em>GLTR: Statistical detection and visualization of generated text</em></td>
    ...
    <tr>
      <td><em>Accommodation theory: Communication, context, and consequence</em></td>
    ...
    <tr>
      <td><em>Speech Style and Social Evaluation</em></td>
    ...
    <tr>
      <td><em>Assessing BERT's syntactic abilities</em></td>
      <td>Yoav Goldberg</td>
    ...
    <tr>
      <td><em>Coh-Metrix: Analysis of text on cohesion and language</em></td>
    ...
    <tr>
      <td><em>The Idea of Progress in Forensic Authorship Analysis</em></td>
      <td>Tim Grant</td>
    ...
    <tr>
      <td><em>Quantitative authorship attribution: An evaluation of techniques</em></td>
      <td>Jack Grieve</td>
    ...
    <tr>
      <td><em>Register variation explains stylometric authorship analysis</em></td>
      <td>Jack Grieve</td>
    ...
    <tr>
      <td><em>The sociolinguistic foundations of language modeling</em></td>
    ...
    <tr>
      <td><em>Variation among blogs: A multi-dimensional analysis</em></td>
    ...
    <tr>
      <td><em>Benchmarking Linguistic Diversity of Large Language Models</em></td>
    ...
    <tr>
      <td><em>The curious decline of linguistic diversity: Training language models on synthetic text</em></td>
    ...
    <tr>
      <td><em>Annotation artifacts in natural language inference data</em></td>
    ...
    <tr>
      <td><em>Towards style alignment in cross-cultural translation</em></td>
    ...
    <tr>
      <td><em>Representation learning of writing style</em></td>
    ...
    <tr>
      <td><em>Measuring Mathematical Problem Solving With the MATH Dataset</em></td>
    ...
    <tr>
      <td><em>Looking for the inner music: Probing LLMs' understanding of literary style</em></td>
    ...
    <tr>
      <td><em>AI generates covertly racist decisions about people based on their dialect</em></td>
    ...
    <tr>
      <td><em>Intonation and referee design phenomena in the narrative speech of Black/biracial men</em></td>
    ...
    <tr>
      <td><em>The analysis of literary style – a review</em></td>
    ...
    <tr>
      <td><em>ParaGuide: Guided diffusion paraphrasers for plug-and-play textual style transfer</em></td>
    ...
    <tr>
      <td><em>TinyStyler: Efficient few-shot text style transfer with authorship embeddings</em></td>
    ...
    <tr>
      <td><em>N-gram feature selection for authorship identification</em></td>
    ...
    <tr>
      <td><em>Demographic factors improve classification performance</em></td>
      <td>Dirk Hovy</td>
    ...
    <tr>
      <td><em>"You Sound Just Like Your Father" Commercial Machine Translation Systems Include Stylistic Biases</em></td>
    ...
    <tr>
      <td><em>The social impact of natural language processing</em></td>
    ...
    <tr>
      <td><em>Tagging Performance Correlates with Author Age</em></td>
    ...
    <tr>
      <td><em>The importance of modeling social factors of language: Theory and practice</em></td>
    ...
    <tr>
      <td><em>Authorship Attribution in the Era of LLMs: Problems, Methodologies, and Challenges</em></td>
    ...
    <tr>
      <td><em>Sparse autoencoders find highly interpretable features in language models</em></td>
    ...
    <tr>
      <td><em>"Style" as distinctiveness: the culture and ideology of linguistic differentiation</em></td>
    ...
    <tr>
      <td><em>The Million Authors Corpus: A Cross-Lingual and Cross-Domain Wikipedia Dataset for Authorship Verification</em></td>
    ...
    <tr>
      <td><em>Style versus Content: A distinction without a (learnable) difference?</em></td>
    ...
    <tr>
      <td><em>Evaluating Style-Personalized Text Generation: Challenges and Directions</em></td>
    ...
    <tr>
      <td><em>Shakespearizing Modern Language Using Copy-Enriched Sequence to Sequence Models</em></td>
    ...
    <tr>
      <td><em>Deep learning for text style transfer: A survey</em></td>
    ...
    <tr>
      <td><em>Disentangled representation learning for non-parallel text style transfer</em></td>
    ...
    <tr>
      <td><em>Authorship attribution</em></td>
      <td>Patrick Juola</td>
    ...
    <tr>
      <td><em>JGAAP 4.0–A revised authorship attribution tool</em></td>
    ...
    <tr>
      <td><em>(male, bachelor) and (female, Ph.D) have different connotations: Parallelly annotated stylistic language dataset with multiple personas</em></td>
    ...
    <tr>
      <td><em>Style is NOT a single variable: Case Studies for Cross-Stylistic Language Understanding</em></td>
    ...
    <tr>
      <td><em>Function words in authorship attribution. from black magic to theory?</em></td>
    ...
    <tr>
      <td><em>A deep metric learning approach to account linking</em></td>
    ...
    <tr>
      <td><em>Learning to generate text in arbitrary writing styles</em></td>
    ...
    <tr>
      <td><em>Supervised contrastive learning</em></td>
    ...
    <tr>
      <td><em>Leveraging Multilingual Training for Authorship Representation: Enhancing Generalization across Languages and Domains</em></td>
    ...
    <tr>
      <td><em>Working in Language and Law: A German Perspective</em></td>
    ...
    <tr>
      <td><em>What's in an embedding? analyzing word embeddings through multilingual evaluation</em></td>
      <td>Arne Köhn</td>
    ...
    <tr>
      <td><em>Automatically categorizing written texts by author gender</em></td>
    ...
    <tr>
      <td><em>Stylometric detection of ai-generated text in twitter timelines</em></td>
    ...
    <tr>
      <td><em>Sociolinguistic Patterns</em></td>
      <td>William Labov</td>
    ...
    <tr>
      <td><em>The Social Stratification of English in New York City, 2nd edition</em></td>
      <td>William Labov</td>
      <td><a href="https://doi.org/10.1017/CBO9780511618208">link</a></td>
      <td>2006</td>
      <td>Cambridge University Press</td>
    ...
    <tr>
      <td><em>Tulu 3: Pushing Frontiers in Open Language Model Post-Training</em></td>
    ...
    <tr>
      <td><em>Where does the sociolinguistic variable stop?</em></td>
    ...
    <tr>
      <td><em>LFTK: Handcrafted Features in Computational Linguistics</em></td>
    ...
    <tr>
      <td><em>Diverse Demonstrations Improve In-context Compositional Generalization</em></td>
    ...
    <tr>
      <td><em>TextBugger: Generating Adversarial Text Against Real-world Applications</em></td>
    ...
    <tr>
      <td><em>Towards robust and privacy-preserving text representations</em></td>
    ...
    <tr>
      <td><em>Textbooks Are All You Need II: phi-1.5 technical report</em></td>
    ...
    <tr>
      <td><em>GPT detectors are biased against non-native English writers</em></td>
    ...
    <tr>
      <td><em>Let's Verify Step by Step</em></td>
    ...
    <tr>
      <td><em>Style over Substance: Distilled Language Models Reason Via Stylistic Replication</em></td>
    ...
    <tr>
      <td><em>Anonymisation models for text data: State of the art, challenges and future directions</em></td>
    ...
    <tr>
      <td><em>Enct5: A framework for fine-tuning t5 as non-autoregressive models</em></td>
    ...
    <tr>
      <td><em>RECAP: Retrieval-enhanced context-aware prefix encoder for personalized dialogue response generation</em></td>
    ...
    <tr>
      <td><em>More than words: The influence of affective content and linguistic style matches in online reviews on conversion rates</em></td>
    ...
    <tr>
      <td><em>Politeness transfer: A tag and generate approach</em></td>
    ...
    <tr>
      <td><em>Jointly learning author and annotated character n-gram embeddings: A case study in literary text</em></td>
    ...
    <tr>
      <td><em>Rephrasing the Web: A Recipe for Compute and Data-Efficient Language Modeling</em></td>
    ...
    <tr>
      <td><em>Counterfactual augmentation for robust authorship representation learning</em></td>
    ...
    <tr>
      <td><em>Language technologies as if people mattered: Centering communities in language technology development</em></td>
    ...
    <tr>
      <td><em>Umap: Uniform manifold approximation and projection for dimension reduction</em></td>
    ...
    <tr>
      <td><em>Introducing Sociolinguistics</em></td>
    ...
    <tr>
      <td><em>Linguistic profiling of a neural language model</em></td>
    ...
    <tr>
      <td><em>Stranger than paradigms word embedding benchmarks don't align with morphology</em></td>
    ...
    <tr>
      <td><em>Investigating topic influence in authorship attribution</em></td>
    ...
    <tr>
      <td><em>The signature stylometric system</em></td>
    ...
    <tr>
      <td><em>State of what art? a call for multi-prompt LLM evaluation</em></td>
    ...
    <tr>
      <td><em>Inference in an authorship problem: A comparative study of discrimination methods applied to the authorship of the disputed federalist papers</em></td>
    ...
    <tr>
      <td><em>MTEB: Massive Text Embedding Benchmark</em></td>
    ...
    <tr>
      <td><em>s1: Simple test-time scaling</em></td>
    ...
    <tr>
      <td><em>Does your style engage? linguistic styles of influencers and digital consumer engagement on youtube</em></td>
    ...
    <tr>
      <td><em>Surveying stylometry techniques and applications</em></td>
    ...
    <tr>
      <td><em>Collaborative growth: When large language models meet sociolinguistics</em></td>
      <td>Dong Nguyen</td>
    ...
    <tr>
      <td><em>Computational sociolinguistics: A Survey</em></td>
    ...
    <tr>
      <td><em>"How old do you think I am?" A study of language and age in Twitter</em></td>
    ...
    <tr>
      <td><em>We Need to Measure Data Diversity in NLP – Better and Broader</em></td>
    ...
    <tr>
      <td><em>On learning and representing social meaning in NLP: a sociolinguistic perspective</em></td>
    ...
    <tr>
      <td><em>The Multi-Dimensional Analysis Tagger</em></td>
      <td>Andrea Nini</td>
    ...
    <tr>
      <td><em>A Theory of Linguistic Individuality for Authorship Analysis</em></td>
      <td>Andrea Nini</td>
      <td><a href="https://doi.org/10.1017/9781108974714">link</a></td>
      <td>2023</td>
      <td>Cambridge University Press</td>
    ...
    <tr>
      <td><em>A study of style in machine translation: Controlling the formality of machine translation output</em></td>
    ...
    <tr>
      <td><em>Multi-task neural models for translating between styles within and across languages</em></td>
    ...
    <tr>
      <td><em>Linguistic style and crowdfunding success among social and commercial entrepreneurs</em></td>
    ...
    <tr>
      <td><em>Learning interpretable style embeddings via prompting LLMs</em></td>
    ...
    <tr>
      <td><em>StyleDistance: Stronger content-independent style embeddings with synthetic parallel examples</em></td>
    ...
    <tr>
      <td><em>Language independent authorship attribution using character level language models</em></td>
    ...
    <tr>
      <td><em>The Development and Psychometric Properties of LIWC2015</em></td>
    ...
    <tr>
      <td><em>JSAN–The Integrated JStylo and Anonymouth Package</em></td>
    ...
    <tr>
      <td><em>Mind the style of text! adversarial and backdoor attacks based on text style transfer</em></td>
    ...
    <tr>
      <td><em>Overview of the author profiling task at PAN 2013</em></td>
    ...
    <tr>
      <td><em>Dear sir or madam, may I introduce the GYAFC dataset: Corpus, benchmarks and metrics for formality style transfer</em></td>
    ...
    <tr>
      <td><em>A recipe for arbitrary text style transfer with large language models</em></td>
    ...
    <tr>
      <td><em>Addressee- and topic-influenced style shift: A quantitative sociolinguistic study</em></td>
    ...
    <tr>
      <td><em>Topic-regularized authorship representation learning</em></td>
    ...
    <tr>
      <td><em>Addressing Topic Leakage in Cross-Topic Evaluation for Authorship Verification</em></td>
    ...
    <tr>
      <td><em>MATCHED: Multimodal Authorship-Attribution To Combat Human Trafficking in Escort-Advertisement Data</em></td>
    ...
    <tr>
      <td><em>Frequent-words analysis for forensic speaker comparison</em></td>
    ...
    <tr>
      <td><em>The power of words: Driving online consumer engagement in Fintech</em></td>
    ...
    <tr>
      <td><em>Does string-based neural MT learn source syntax?</em></td>
    ...
    <tr>
      <td><em>Personalized author obfuscation with large language models</em></td>
    ...
    <tr>
      <td><em>A survey of modern authorship attribution methods</em></td>
    ...
    <tr>
      <td><em>Masking topic-related information to enhance authorship attribution</em></td>
      <td>Efstathios Stamatatos</td>
    ...
    <tr>
      <td><em>Multi-label style change detection by solving a binary classification problem</em></td>
      <td>Eivind Strøm</td>
    ...
    <tr>
      <td><em>Dialect-robust evaluation of generated text</em></td>
    ...
    <tr>
      <td><em>Idiosyncrasies in large language models</em></td>
    ...
    <tr>
      <td><em>Unsupervised neural text simplification</em></td>
    ...
    <tr>
      <td><em>What do you learn from context? Probing for sentence structure in contextualized word representations</em></td>
    ...
    <tr>
      <td><em>Writing Style Author Embedding Evaluation</em></td>
    ...
    <tr>
      <td><em>Stayal | multilingual style transfer</em></td>
    ...
    <tr>
      <td><em>Reddust: A large reusable dataset of reddit user traits</em></td>
    ...
    <tr>
      <td><em>HANSEN: Human and AI spoken text benchmark for authorship analysis</em></td>
    ...
    <tr>
      <td><em>Research Methods: The Essential Knowledge Base</em></td>
    ...
    <tr>
      <td><em>Persona-Augmented Benchmarking: Evaluating LLMs Across Diverse Writing Styles</em></td>
    ...
    <tr>
      <td><em>Authorship attribution for neural text generation</em></td>
    ...
    <tr>
      <td><em>Paraphrase types elicit prompt engineering capabilities</em></td>
    ...
    <tr>
      <td><em>Can authorship representation learning capture stylistic features?</em></td>
    ...
    <tr>
      <td><em>Feature vector difference based neural network and logistic regression models for authorship verification</em></td>
    ...
    <tr>
      <td><em>Does it capture STEL? a modular, similarity-based linguistic style evaluation framework</em></td>
    ...
    <tr>
      <td><em>Tokenization is sensitive to language variation</em></td>
    ...
    <tr>
      <td><em>Same Author or Just Same Topic? Towards Content-Independent Style Representations</em></td>
    ...
    <tr>
      <td><em>Constraints on the agentless passive</em></td>
    ...
    <tr>
      <td><em>Disentangling style factors from speaker representations</em></td>
    ...
    <tr>
      <td><em>Style over substance: Evaluation biases for large language models</em></td>
    ...
    <tr>
      <td><em>Out-of-distribution generalization in natural language processing: Past, present, and future</em></td>
    ...
    <tr>
      <td><em>A Survey of Controllable Text Generation Using Transformer-based Pre-trained Language Models</em></td>
    ...
    <tr>
      <td><em>Personalized Text Generation with Contrastive Activation Steering</em></td>
    ...
    <tr>
      <td><em>How Well Do Text Embedding Models Understand Syntax?</em></td>
    ...
    <tr>
      <td><em>Personalization of Large Language Models: A Survey</em></td>
    ...
    <tr>
      <td><em>Unmasking style sensitivity: A causal analysis of bias evaluation instability in large language models</em></td>
    ...
    <tr>
      <td><em>Disentangled sequence to sequence learning for compositional generalization</em></td>
    ...
    <tr>
      <td><em>Idiosyncratic but not Arbitrary: Learning Idiolects in Online Registers Reveals Distinctive yet Consistent Individual Styles</em></td>
    ...
    <tr>
      <td><em>StyleFlow: Disentangle latent representations via normalizing flow for unsupervised text style transfer</em></td>
    ...
    <tr>
      <td><em>Trans self-identification and the language of neoliberal selfhood: Agency, power, and the limits of monologic discourse</em></td>
      <td>Lal Zimman</td>
    ...
    <tr>
      <td><em>An ensemble-rich multi-aspect approach for robust style change detection</em></td>
    ...
    <tr>
      <td><em>Style change detection with feed-forward neural networks</em></td>
